...
def parse_option():
    ...
    parser.add_argument('--model_s', type=str, default='resnet8',
                        choices=['resnet8', 'resnet14', 'resnet20','resnet20PCA', 'resnet32', 'resnet44', 'resnet56','resnet56PCA', 'resnet110','resnet110PCA',
    ...
    # PCA distillation 
    parser.add_argument('--crit_type', default='mse', type=str, choices=['mse', 'cosine'])
    parser.add_argument('--loss_type', default='raw', type=str, choices=['raw', 'pca_s','mahalanobis_distance'])
